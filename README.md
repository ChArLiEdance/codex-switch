...
Version `1.1.1` adds the first usable **Skills** and **Prompts** management flow, alongside the existing account switching, login, quota, settings, usage statistics, session history, and tray menu foundation.
...
Download installers from the [GitHub Releases](https://github.com/ChArLiEdance/codex-switch/releases) page. The current `1.1.1` release provides macOS Apple Silicon and Windows x64 installers.

### macOS

1. Download [`codex_switch_1.1.1_aarch64.dmg`](https://github.com/ChArLiEdance/codex-switch/releases/download/v1.1.1/codex_switch_1.1.1_aarch64.dmg).
2. Open the `.dmg`.
...
If you prefer a package installer, download [`codex_switch_1.1.1_aarch64.pkg`](https://github.com/ChArLiEdance/codex-switch/releases/download/v1.1.1/codex_switch_1.1.1_aarch64.pkg) and open it.
...
1. Download [`codex_switch_1.1.1_x64-setup.exe`](https://github.com/ChArLiEdance/codex-switch/releases/download/v1.1.1/codex_switch_1.1.1_x64-setup.exe).
2. Run the installer.
...
Current release assets for `1.1.1`:
...
The repository also has GitHub Actions configured to build release artifacts from version tags. The `1.1.1` public release intentionally does not include macOS x64.
