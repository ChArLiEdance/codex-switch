...
- Successful restore transactions update Profile `lastUsedAt`, record the previous Profile id and display name in local history, and expose Home actions for restoring the default Profile or switching back to the previous Profile without relying on display-name uniqueness.
